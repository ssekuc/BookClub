...
var auth_controller_server_1 = require("../controllers/auth.controller.server");
//const router = Router();
...
// Create a new Role
router.post('/roles', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var Role, newRole, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
